...
import com.kchat.core.model.SearchQueryRules
import com.kchat.core.ui.keyboardScrollOnFocus
...
fun KChatSearchField(
    ...
    OutlinedTextField(
        value = value,
        onValueChange = { raw -> onValueChange(SearchQueryRules.sanitize(raw)) },
